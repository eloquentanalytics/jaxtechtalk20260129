...
**Thesis:** Large incumbents face structural barriers—baseline measurement costs, incentive misalignment, and organizational inertia—that make AI-first transformation nearly impossible, creating a massive opportunity for domain experts to found startups that serve markets incumbents cannot profitably address.

**Audience:** Mixed (VCs, founders, operators, engineers) at Jax Tech
**Speaker:** Philip O'Donnell
**Duration:** 20 minutes
...
- The AI Innovator's Dilemma
- One-line thesis: The same forces that made incumbents powerful now prevent them from going AI-first
...
│                                                         │
│  ┌─────────────────────────────────────────────────┐   │
│  │  "The same forces that made incumbents powerful │   │
│  │   now prevent them from going AI-first"         │   │
│  └─────────────────────────────────────────────────┘   │
│                                                         │
│                        Philip O'Donnell                 │
│                        Jax Tech · Jan 2026              │
└─────────────────────────────────────────────────────────┘
```
- Dark background, large centered title
- Subtitle in lighter weight below
...
- N2: Pick and Choose Process Slices — startups can specialize where enterprises must generalize
- L1: Serving Nonconsumption — AI makes previously uneconomical services viable
...
- D2: Percentage-Based Valuation Penalizes Lower Margins — Wall Street rewards margin expansion
- D5: Investment Horizon Mismatch — quarterly pressure favors immediate cost savings over long-term growth bets
- E2: Commission-Based Compensation Steers Toward Easy Wins — incentive structures optimize for current business
...
## Next Steps
- [ ] Research & evidence collection for each slide
